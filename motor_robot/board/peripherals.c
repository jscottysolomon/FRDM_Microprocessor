...
- name: BOARD_InitPeripherals
  UUID: f8154263-6991-4f14-9371-31a6da8ef7d4
  called_from_default_init: true
  selectedCore: core0
- name: BOARD_InitButtonsPeripheral
  UUID: 8221045a-ccdb-41a4-9185-8be7d50d5c0f
  id_prefix: BOARD_
  selectedCore: core0
- name: BOARD_InitLEDsPeripheral
  UUID: e9ec642c-bcdb-40d8-b080-b2c35ee13a5b
  id_prefix: BOARD_
  selectedCore: core0
- name: BOARD_InitACCELPeripheral
  UUID: 00d4a78e-59f5-46ed-bb24-3ee1e64021af
  id_prefix: BOARD_
  selectedCore: core0
- name: BOARD_InitMAGPeripheral
  UUID: 4a13060f-5d91-4318-ba81-a2bb764ad7af
  selectedCore: core0
- name: BOARD_InitDEBUG_UARTPeripheral
  UUID: a9196efe-6584-47ba-9e54-2310afbf1bf4
  id_prefix: BOARD_
  selectedCore: core0
