...
- name: BOARD_InitPeripherals
  UUID: 77844be5-d9b4-4a7a-8684-41133bba85a0
  called_from_default_init: true
  selectedCore: core0
- name: BOARD_InitButtonsPeripheral
  UUID: bebc344c-890a-468d-80e9-23a732c5a48d
  id_prefix: BOARD_
  selectedCore: core0
- name: BOARD_InitLEDsPeripheral
  UUID: 739271bf-afb4-4f82-a313-765bb86a612d
  id_prefix: BOARD_
  selectedCore: core0
- name: BOARD_InitACCELPeripheral
  UUID: 76da9680-86e0-4752-b3b2-c2506ff0fde8
  id_prefix: BOARD_
  selectedCore: core0
- name: BOARD_InitMAGPeripheral
  UUID: cccdc696-0e9c-4ed6-8a3a-010451666be3
  selectedCore: core0
- name: BOARD_InitDEBUG_UARTPeripheral
  UUID: b221e21b-8bd3-4d35-9e8e-9e8975daafb2
  id_prefix: BOARD_
  selectedCore: core0
