...
- name: BOARD_InitPeripherals
  UUID: 10928554-4376-4a61-b9a1-7dac66b0b608
  called_from_default_init: true
  selectedCore: core0
- name: BOARD_InitButtonsPeripheral
  UUID: ebb1aa32-4495-49d8-bc5f-6f1e9f10d394
  id_prefix: BOARD_
  selectedCore: core0
- name: BOARD_InitLEDsPeripheral
  UUID: 0430b8e7-e2c0-4c24-87ab-a811d965a1f7
  id_prefix: BOARD_
  selectedCore: core0
- name: BOARD_InitACCELPeripheral
  UUID: 870a3fb1-d495-41d8-99ec-8079b67e37ae
  id_prefix: BOARD_
  selectedCore: core0
- name: BOARD_InitMAGPeripheral
  UUID: 0c64c208-ca63-45a6-8f18-595dc63a54c5
  selectedCore: core0
- name: BOARD_InitDEBUG_UARTPeripheral
  UUID: 7288b4ca-b5e6-40b6-a031-34483c229f0a
  id_prefix: BOARD_
  selectedCore: core0
